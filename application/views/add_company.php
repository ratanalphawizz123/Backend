...
<input type="hidden" class="form-control"   name="filed[<?php echo $key?>]" value="<?php echo $filed; ?>">
                          </div>
                <?php $j++;} ?>
                ...
                <div class="col-md-12">
                  ...
                  <button type="submit" name="addcompany" value="addcompany" disabled class="btn btn-default">Add Company</button>
                  <input type="hidden" name="tablename"  value="<?php echo $tablename;?>">
                  <input type="hidden" name="pagename" value="<?php echo $pagename1;?>">
            <input type="hidden" name="datatype" value='<?php echo  $datatype1;?>'>
            <input type="hidden" name="datatypeval" value='<?php echo  $datatypeval1;?>'>
           <input type="hidden" name="datatypevalmsg" value='<?php echo  $datatypeval22;?>'>       
