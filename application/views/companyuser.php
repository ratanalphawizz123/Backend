...
foreach($row3 as $column) {
 $id = $row3[0];
  ...
  ?>
      ...
      <a  href="edit_companyuser?ID=<?php echo $id; ?>&deltablename=<?php echo $tablename; ?>&pagename=<?php echo $pagename; ?>&Parameter=<?php echo $Parameter ;?>&idname=<?php echo $idname;?>"><i class="fa fa-edit"></i></a>
        <a href="#"><i class="fa fa-trash"></i></a>
                                  </td> 
                                </tr>
                            <?php  } } ?>
                        </tbody>
                        <a href="add_companyuser?deltablename=<?php echo $tablename; ?>&pagename=<?php echo $pagename; ?>&Parameter=<?php echo $Parameter ;?>" class="add_button">+</a>
                    </table>
                  </div>
              </div>
            </div>
