...
foreach($filed as $key)
{
    ...
    if(array_key_exists($key, $array))
    {
       ...
       $sql3="Select $newfiled FROM $TableName LEFT OUTER JOIN State ON Country.Country_Code = State.Country_Code where $TableName.REC_status='1'";                          
...
foreach($row3 as $column) {
 $id = $row3[0];
  ...
  ?>
      ...
      <a  href="edit_country.php?ID=<?php echo $id; ?>&deltablename=<?php echo $tablename; ?>&pagename=<?php echo $pagename; ?>&Parameter=<?php echo $Parameter ;?>&idname=<?php echo $idname;?>"><i class="fa fa-edit"></i></a>
        <a href="delete.php?ID=<?php echo $id; ?>&deltablename=<?php echo $tablename; ?>&pagename=<?php echo $pagename; ?>&Parameter=<?php echo $Parameter ;?>&idname=<?php echo $idname;?>"><i class="fa fa-trash"></i></a>
                        ...
                        <a href="add_country.php?deltablename=<?php echo $tablename; ?>&pagename=<?php echo $pagename; ?>&Parameter=<?php echo $Parameter ;?>" class="add_button">+</a>
                    </table>
                  </div>
              </div>
            </div>
