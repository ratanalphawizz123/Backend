...
$TableName= "Language"; // We need to assign which table do this program will generate from here. There is no relationship between list configuration and logical table in terms of content
...
$row2 =mysqli_fetch_assoc($sql2);?>
 ...
 $i++;
    ...
    $sql3="SELECT Language.Language_Code, Language.Language FROM Language";                          
