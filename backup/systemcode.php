...
$TableName= "System Code"; // We need to assign which table do this program will generate from here. There is no relationship between list configuration and logical table in terms of content
...
$row2 =mysqli_fetch_assoc($sql2);?>
 ...
 $i++;
    ...
    $sql3="SELECT SystemCode.System_code, SystemCode.System_message, SystemCode.System_description From SystemCode where SystemCode.Language = '".$Language."'";                          
$sql3=mysqli_query($db,$sql3);
      ...
      <a  href="edit_systemcode.php?id=<?php echo $empID ?>&deltablename=<?php echo $tablename; ?>&pagename=<?php echo $pagename; ?>&Parameter=<?php echo $Parameter ;?>"><i class="fa fa-edit"></i></a>
        <a href="delete.php?id=<?php echo $empID ?>&deltablename=<?php echo $tablename; ?>&pagename=<?php echo $pagename; ?>&Parameter=<?php echo $Parameter ;?>"><i class="fa fa-trash"></i></a>
                        ...
                        <a href="add_systemcode.php?deltablename=<?php echo $tablename; ?>&pagename=<?php echo $pagename; ?>&Parameter=<?php echo $Parameter ;?>" class="add_button">+</a>
                    </table>
                  </div>
              </div>
            </div>
